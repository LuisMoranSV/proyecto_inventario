...
foreach($products as $product):
    ...
    <td><?php echo $product->inventary_min; ?></td>
		<td>
		<?php if($q==0){ echo "<span class='label label-danger'>AGOTADO.</span>";}else if($q<=$product->inventary_min/2){ echo "<span class='label label-danger'>AGOTANDOSE.</span>";} else if($q<=$product->inventary_min){ echo "<span class='label label-warning'>MINIMO ALCANZADO.</span>";} ?>
		</td>
	</tr>
<?php endif;?>
<?php
...
<div class="clearfix"></div>
	...
	<div class="jumbotron">
		...
		<p>Sin alertas de inventario, estas se muestran cuando el inventario ha alcanzado el nivel minimo.</p>
	</div>
	<?php
}
