...
<!-- color Header -->
  <body class="<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])):?>   sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      <!-- Main Header -->
      ...
      <img class="" src="img/user.png" alt="Usuario" height="17" width="17">
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu ">
            ...
            <li><a href="./?view=sell"><i class='fa fa-usd'></i> <span>Salidas</span></a></li>
            <li><a href="./?view=sells"><i class='fa fa-shopping-cart'></i> <span>Historial Salidas</span></a></li>
   ...
   <!--                     <li class="treeview">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Ingenieria de software 1<a target="_blank"></a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a style="color:white" href="./">Sistema de <b>Inventario</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <form action="./?action=processlogin" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button style="color:white" type="submit" class="btn btn-primary btn-block btn-flat">Acceder</button>
            </div><!-- /.col -->
          </div>
        </form>
      </div><!-- /.login-box-body -->
